...
function AddBrand() {
  ...
  const {
    ...
    defaultValues: {
      variants: [
        { size: '', color: '', price: 0, countInStock: 0, sku: '' }
      ]
    }
  });
  ...
  const onCreateBrand: SubmitHandler<Product> = async (data) => {
    ...
    data.variants.forEach((variant, index) => {
      ...
      formData.append(`variants[${index}][countInStock]`, variant.countInStock.toString());
        ...
        <div className="rounded-lg border bg-ui-bg-base p-7">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label
                htmlFor="image"
                className="text-sm mb-2 block font-medium text-ui-fg-subtle"
              >
                Image
              </label>
              <p className="text-xs mb-2 text-ui-fg-muted">
              ...
              >
                ...
                <p className="text-xs mb-2 text-center text-ui-fg-muted">
            ...
            {/* Variants */}
            <div>
              <h2 className="text-lg font-medium text-ui-fg-base">Product Variants</h2>
              {fields.map((field, index) => (
                <div key={field.id} className="flex space-x-4 mt-4">
              ...
              <Button type="button" onClick={() => append({ size: '', color: '', price: 0, countInStock: 0, sku: '' })}>
                Add Variant
              </Button>
            </div>
          </div>
