...
const MyBarChart = () => {
    ...
    const [productStats, setProductStats] = useState<{ name: string, quantity: number }[]>([]);
    ...
    return (
        <div  className='bg-white p-6 m-6 rounded-lg shadow mb-8 pb-20' >
            <h2 className='text-xl m-6 font-semibold '>Sản Phẩm bán chạy</h2>
