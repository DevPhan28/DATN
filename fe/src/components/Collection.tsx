            ...
            <section className="deal-timer position-relative d-flex align-items-end overflow-hidden" style={{ backgroundColor: '#ebebeb' }}>
                ...
                <div className="deal-timer-wrapper container position-relative">
                    <div className="deal-timer__content pb-2 mb-3 pb-xl-5 mb-xl-3 mb-xxl-5">
                        <p className="text_dash text-uppercase text-red fw-medium">Ưu đãi trong tuần</p>
                        <h3 className="h1 text-uppercase"> Bộ sưu tập <strong>mùa xuân</strong></h3>
                        <Link to="/shop" className="btn-link default-underline text-uppercase fw-medium mt-3">Khám phá ngay</Link>
                    </div>
                    <div className="position-relative d-flex align-items-center text-center pt-xxl-4 js-countdown" data-date="18-5-2024" data-time="06:50">
                        <div className="day countdown-unit">
                            ...
                            <span className="countdown-word fw-bold text-uppercase text-secondary">Ngày</span>
                        </div>
                        <div className="hour countdown-unit">
                            <span className="countdown-num d-block" />
                            <span className="countdown-word fw-bold text-uppercase text-secondary">Giờ</span>
                        </div>
                        <div className="min countdown-unit">
                            <span className="countdown-num d-block" />
                            <span className="countdown-word fw-bold text-uppercase text-secondary">Phút</span>
                        </div>
                        <div className="sec countdown-unit">
                            <span className="countdown-num d-block" />
                            <span className="countdown-word fw-bold text-uppercase text-secondary">Giây</span>
                        </div>
                    </div>
                        ...
                        <div className="row ">
                            <div className="col-md-6">
                                <div className="grid-banner__item grid-banner__item_rect position-relative mb-3">
                                    ...
                                    <div className="content_abs content_bottom content_left content_bottom-lg content_left-lg">
                                        <h6 className="text-uppercase text-white fw-medium mb-3">Đồng giá chỉ 199.000 vnd</h6>
                                        <h3 className="text-white mb-3">Áo thun nữ</h3>
                                        <Link to="/shop" className="btn-link default-underline text-uppercase text-white fw-medium">Khám phá ngay</Link>
                            ...
                            <div className="col-md-6">
                                <div className="grid-banner__item grid-banner__item_rect position-relative mb-3">
                                    ...
                                    <div className="content_abs content_bottom content_left content_bottom-lg content_left-lg">
                                        <h6 className="text-uppercase fw-medium mb-3">Đồng giá chi 259.000 vnd</h6>
                                        <h3 className="mb-3">Đồ thể thao nam</h3>
