                            ...
                            <ul className="navigation__list list-unstyled d-flex">
                                    ...
                                    <div className="box-menu" style={{ width: 800 }}>
                                        <div className="col pe-4">
                                            <ul className="sub-menu__list list-unstyled">
                                                ...
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo4/index.html" className="menu-link menu-link_us-s">Home 4</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo5/index.html" className="menu-link menu-link_us-s">Home 5</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo6/index.html" className="menu-link menu-link_us-s">Home 6</a></li>
                                            </ul>
                                        </div>
                                        <div className="col pe-4">
                                            <ul className="sub-menu__list list-unstyled">
                                                ...
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo10/index.html" className="menu-link menu-link_us-s">Home 10</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo11/index.html" className="menu-link menu-link_us-s">Home 11</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo12/index.html" className="menu-link menu-link_us-s">Home 12</a></li>
                                            </ul>
                                        </div>
                                        <div className="col pe-4">
                                            <ul className="sub-menu__list list-unstyled">
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo13/index.html" className="menu-link menu-link_us-s">Home 13</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo14/index.html" className="menu-link menu-link_us-s">Home 14</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo15/index.html" className="menu-link menu-link_us-s">Home 15</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo16/index.html" className="menu-link menu-link_us-s">Home 16</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo17/index.html" className="menu-link menu-link_us-s">Home 17</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo18/index.html" className="menu-link menu-link_us-s">Home 18</a></li>
                                            </ul>
                                        </div>
                                        <div className="col">
                                            <ul className="sub-menu__list list-unstyled">
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo19/index.html" className="menu-link menu-link_us-s">Home 19</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo20/index.html" className="menu-link menu-link_us-s">Home 20</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo21/index.html" className="menu-link menu-link_us-s">Home 21</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo22/index.html" className="menu-link menu-link_us-s">Home 22</a></li>
                                                <li className="sub-menu__item"><a href="https://uomo-html.flexkitux.com/Demo23/index.html" className="menu-link menu-link_us-s">Home 23</a></li>
                                            </ul>
                                        </div>
                                    </div>{/* /.box-menu */}
                                </li>
                                    ...
                                    <div className="mega-menu">
                                        <div className="container d-flex">
                                            <div className="col pe-4">
                                                ...
                                                <ul className="sub-menu__list list-unstyled">
                                                    <li className="sub-menu__item"><a href="shop1.html" className="menu-link menu-link_us-s">Shop List V1</a>
                                                    </li>
                                                    <li className="sub-menu__item"><a href="shop2.html" className="menu-link menu-link_us-s">Shop List V2</a>
                                                    </li>
                                                    <li className="sub-menu__item"><a href="shop3.html" className="menu-link menu-link_us-s">Shop List V3</a>
                                                    </li>
                                                    <li className="sub-menu__item"><a href="shop4.html" className="menu-link menu-link_us-s">Shop List V4</a>
                                                    </li>
                                                    <li className="sub-menu__item"><a href="shop5.html" className="menu-link menu-link_us-s">Shop List V5</a>
                                                    </li>
                                                    <li className="sub-menu__item"><a href="shop6.html" className="menu-link menu-link_us-s">Shop List V6</a>
                                                    </li>
                                                    <li className="sub-menu__item"><a href="shop7.html" className="menu-link menu-link_us-s">Shop List V7</a>
                                                    </li>
                                                    <li className="sub-menu__item"><a href="shop8.html" className="menu-link menu-link_us-s">Shop List V8</a>
                                                    </li>
                                                    <li className="sub-menu__item"><a href="shop9.html" className="menu-link menu-link_us-s">Shop List V9</a>
                                                    </li>
                                                    <li className="sub-menu__item"><a href="shop10.html" className="menu-link menu-link_us-s">Shop Item
                                                        Style</a></li>
                                                    <li className="sub-menu__item"><a href="shop11.html" className="menu-link menu-link_us-s">Horizontal
                                                        Scroll</a></li>
                                                </ul>
                                            </div>
                                            <div className="col pe-4">
                                                ...
                                                <ul className="sub-menu__list list-unstyled">
                                                    <li className="sub-menu__item"><a href="product2_variable.html" className="menu-link menu-link_us-s">Shop
                                                        Detail V1</a></li>
                                                    <li className="sub-menu__item"><a href="product7_v2.html" className="menu-link menu-link_us-s">Shop Detail
                                                        V2</a></li>
                                                    <li className="sub-menu__item"><a href="product8_v3.html" className="menu-link menu-link_us-s">Shop Detail
                                                        V3</a></li>
                                                    <li className="sub-menu__item"><a href="product9_v4.html" className="menu-link menu-link_us-s">Shop Detail
                                                        V4</a></li>
                                                    <li className="sub-menu__item"><a href="product10_v5.html" className="menu-link menu-link_us-s">Shop
                                                        Detail V5</a></li>
                                                    <li className="sub-menu__item"><a href="product11_v6.html" className="menu-link menu-link_us-s">Shop
                                                        Detail V6</a></li>
                                                    <li className="sub-menu__item"><a href="product12_v7.html" className="menu-link menu-link_us-s">Shop
                                                        Detail V7</a></li>
                                                    <li className="sub-menu__item"><a href="product13_v8.html" className="menu-link menu-link_us-s">Shop
                                                        Detail V8</a></li>
                                                    <li className="sub-menu__item"><a href="product14_v9.html" className="menu-link menu-link_us-s">Shop
                                                        Detail V9</a></li>
                                                    <li className="sub-menu__item"><a href="product15_v10.html" className="menu-link menu-link_us-s">Shop
                                                        Detail V10</a></li>
                                                    <li className="sub-menu__item"><a href="product16_v11.html" className="menu-link menu-link_us-s">Shop
                                                        Detail V11</a></li>
                                                </ul>
                                            </div>
                                            <div className="col pe-4">
                                                ...
                                                <ul className="sub-menu__list list-unstyled">
                                                    <li className="sub-menu__item"><a href="shop12.html" className="menu-link menu-link_us-s">Collection
                                                        Grid</a></li>
                                                    <li className="sub-menu__item"><a href="product1_simple.html" className="menu-link menu-link_us-s">Simple
                                                        Product</a></li>
                                                    <li className="sub-menu__item"><a href="product2_variable.html" className="menu-link menu-link_us-s">Variable Product</a></li>
                                                    <li className="sub-menu__item"><a href="product3_external.html" className="menu-link menu-link_us-s">External Product</a></li>
                                                    <li className="sub-menu__item"><a href="product4_grouped.html" className="menu-link menu-link_us-s">Grouped Product</a></li>
                                                    <li className="sub-menu__item"><a href="product5_onsale.html" className="menu-link menu-link_us-s">On
                                                        Sale</a></li>
                                                    <li className="sub-menu__item"><a href="product6_outofstock.html" className="menu-link menu-link_us-s">Out
                                                        of Stock</a></li>
                                                    <li className="sub-menu__item"><a href="shop_cart.html" className="menu-link menu-link_us-s">Shopping
                                                        Cart</a></li>
                                                    <li className="sub-menu__item"><a href="shop_checkout.html" className="menu-link menu-link_us-s">Checkout</a></li>
                                                    <li className="sub-menu__item"><a href="shop_order_complete.html" className="menu-link menu-link_us-s">Order Complete</a></li>
                                                    <li className="sub-menu__item"><a href="shop_order_tracking.html" className="menu-link menu-link_us-s">Order Tracking</a></li>
                                                </ul>
                                            </div>
                                            <div className="mega-menu__media col">
                                                <div className="position-relative">
                                                    <img loading="lazy" className="mega-menu__img" src="../images/mega-menu-item.jpg" alt="New Horizons" />
                                                    <div className="mega-menu__media-content content_abs content_left content_bottom">
                                                        <h3>NEW</h3>
                                                        <h3 className="mb-0">HORIZONS</h3>
                                                        <a href="shop1.html" className="btn-link default-underline fw-medium">SHOP NOW</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li className="navigation__item">
                                    ...
                                    <ul className="default-menu list-unstyled">
                                        <li className="sub-menu__item"><a href="blog_list1.html" className="menu-link menu-link_us-s">Blog V1</a></li>
                                        <li className="sub-menu__item"><a href="blog_list2.html" className="menu-link menu-link_us-s">Blog V2</a></li>
                                        <li className="sub-menu__item"><a href="blog_list3.html" className="menu-link menu-link_us-s">Blog V3</a></li>
                                        <li className="sub-menu__item"><a href="blog_single.html" className="menu-link menu-link_us-s">Blog Detail</a>
                                        </li>
                                    </ul>{/* /.box-menu */}
                                </li>
                                <li className="navigation__item">
                                    ...
                                    <ul className="default-menu list-unstyled">
                                        <li className="sub-menu__item"><a href="account_dashboard.html" className="menu-link menu-link_us-s">My
                                            Account</a></li>
                                        <li className="sub-menu__item"><a href="login_register.html" className="menu-link menu-link_us-s">Login /
                                            Register</a></li>
                                        <li className="sub-menu__item"><a href="store_location.html" className="menu-link menu-link_us-s">Store
                                            Locator</a></li>
                                        <li className="sub-menu__item"><a href="lookbook.html" className="menu-link menu-link_us-s">Lookbook</a></li>
                                        ...
                                        <li className="sub-menu__item"><a href="404.html" className="menu-link menu-link_us-s">404 Error</a></li>
                                        <li className="sub-menu__item"><a href="coming_soon.html" className="menu-link menu-link_us-s">Coming Soon</a>
                                        </li>
                                    </ul>{/* /.box-menu */}
                                </li>
                                <li className="navigation__item">
                ...
                <main>
                                ...
                                <ul className="social-links list-unstyled mb-0 text-secondary">
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/" className="footer__social-link d-block">
                                            <svg className="svg-icon svg-icon_instagram" width={14} height={13} viewBox="0 0 14 13" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                        <a href="https://www.pinterest.com/" className="footer__social-link d-block">
                                            <svg className="svg-icon svg-icon_pinterest" width={14} height={15} viewBox="0 0 14 15" xmlns="http://www.w3.org/2000/svg">
                                                <use href="#icon_pinterest" />
                                            </svg>
                                        </a>
                                    </li>
                                </ul>{/* /.social-links list-unstyled mb-0 text-secondary */}
                                <span className="slideshow-social-follow__title d-block mt-5 text-uppercase fw-medium text-secondary">Follow
                                    Us</span>
                            </div>{/* /.slideshow-social-follow */}
                            <a href="#section-collections-grid_masonry" className="slideshow-scroll d-none d-xxl-block position-absolute end-0 bottom-0 text_dash text-uppercase fw-medium">Scroll</a>
                        </div>
                            ...
                            <div className="row h-md-100">
                                <div className="col-lg-6 h-md-100">
                                    <div className="collection-grid__item position-relative h-md-100">
                                        ...
                                        <div className="content_abs content_bottom content_left content_bottom-md content_left-md">
                                            ...
                                            <h3 className="text-uppercase"><strong>Women</strong> Collection</h3>
                                ...
                                <div className="col-lg-6 d-flex flex-column">
                                    <div className="collection-grid__item position-relative flex-grow-1 mb-lg-4">
                                        ...
                                        <div className="content_abs content_bottom content_left content_bottom-md content_left-md">
                                            <p className="text-uppercase mb-1">Hot List</p>
                                            <h3 className="text-uppercase"><strong>Men</strong> Collection</h3>
                                            <a href="shop1.html" className="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
                                        </div>{/* /.content_abs content_bottom content_left content_bottom-md content_left-md */}
                                    </div>
                                        ...
                                        <div className="row h-md-100">
                                            <div className="col-md-6 h-md-100">
                                                <div className="collection-grid__item h-md-100 position-relative">
                                                    ...
                                                    <div className="content_abs content_bottom content_left content_bottom-md content_left-md">
                                                        <p className="text-uppercase mb-1">Hot List</p>
                                                        <h3 className="text-uppercase"><strong>Kids</strong> Collection</h3>
                                                        <a href="shop1.html" className="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
                                                    </div>{/* /.content_abs content_bottom content_left content_bottom-md content_left-md */}
                                            ...
                                            <div className="col-md-6 h-md-100">
                                                <div className="collection-grid__item h-md-100 position-relative">
                                                    ...
                                                    <div className="content_abs content_bottom content_left content_bottom-md content_left-md">
                                                        <h3 className="text-uppercase"><strong>E-Gift</strong> Cards</h3>
                                                        <p className="mb-1">Surprise someone with the gift they<br />really want.</p>
                                                        <a href="shop1.html" className="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
                                                    </div>{/* /.content_abs content_bottom content_left content_bottom-md content_left-md */}
                                                </div>{/* /.collection-grid__item */}
                                            </div>
                    ...
                    <section className="products-grid container">
                        ...
                        <ul className="nav nav-tabs mb-3 text-uppercase justify-content-center" id="collections-tab" role="tablist">
                            ...
                            <li className="nav-item" role="presentation">
                                <a className="nav-link nav-link_underscore" id="collections-tab-2-trigger" data-bs-toggle="tab" href="#collections-tab-2" role="tab" aria-controls="collections-tab-2" aria-selected="true">New Arrivals</a>
                            </li>
                            <li className="nav-item" role="presentation">
                                <a className="nav-link nav-link_underscore" id="collections-tab-3-trigger" data-bs-toggle="tab" href="#collections-tab-3" role="tab" aria-controls="collections-tab-3" aria-selected="true">Best Seller</a>
                            </li>
                            <li className="nav-item" role="presentation">
                                <a className="nav-link nav-link_underscore" id="collections-tab-4-trigger" data-bs-toggle="tab" href="#collections-tab-4" role="tab" aria-controls="collections-tab-4" aria-selected="true">Top Rated</a>
                            </li>
                        </ul>
                        <div className="tab-content pt-2" id="collections-tab-content">
                                ...
                                <div className="row">
                                        ...
                                        <div className="product-card mb-3 mb-md-4 mb-xxl-5">
                                            <div className="pc__img-wrapper">
                                                <a href="product1_simple.html">
                                                    ...
                                                    <img loading="lazy" src="https://picsum.photos/id/237/200/300" width={330} height={400} alt="Cropped Faux leather Jacket" className="pc__img pc__img-second" />
                                                </a>
                                    ...
                                    <div className="col-6 col-md-4 col-lg-3">
                                        <div className="product-card mb-3 mb-md-4 mb-xxl-5">
                                            <div className="pc__img-wrapper">
                                                <a href="product1_simple.html">
                                                    <img loading="lazy" src="https://picsum.photos/id/237/200/300" width={330} height={400} alt="Cropped Faux leather Jacket" className="pc__img" />
                                                    <img loading="lazy" src="https://picsum.photos/200/300" width={330} height={400} alt="Cropped Faux leather Jacket" className="pc__img pc__img-second" />
                                                </a>
                                                <button className="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium js-add-cart js-open-aside" data-aside="cartDrawer" title="Add To Cart">Add To Cart</button>
                                            </div>
                                            <div className="pc__info position-relative">
                            ...
                            <div className="tab-pane fade show" id="collections-tab-2" role="tabpanel" aria-labelledby="collections-tab-2-trigger">
                                ...
                                <div className="text-center mt-2">
                                    <a className="btn-link btn-link_lg default-underline default-underline text-uppercase fw-medium" href="#">See
                                        All Products</a>
                                </div>
                            </div>{/* /.tab-pane fade show*/}
                            ...
                            <div className="tab-pane fade show" id="collections-tab-4" role="tabpanel" aria-labelledby="collections-tab-4-trigger">
                                ...
                                <div className="text-center mt-2">
                                    <a className="btn-link btn-link_lg default-underline text-uppercase fw-medium" href="shop1.html">See All
                                        Products</a>
                                </div>
                            </div>{/* /.tab-pane fade show*/}
                    ...
                    <section className="deal-timer position-relative d-flex align-items-end overflow-hidden" style={{ backgroundColor: '#ebebeb' }}>
                        <div className="background-img" style={{ backgroundImage: `url(${slide1})` }} />
                        ...
                        <div className="row row-cols-3 row-cols-md-4 row-cols-xl-6">
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 1" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 2" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 3" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 4" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 5" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 6" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 7" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 8" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 9" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 10" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 11" />
                                </a>
                            </div>
                            <div className="instagram__tile">
                                <a href="https://instagram.com/" target="_blank" className="position-relative overflow-hidden d-block effect overlay-plus">
                                    <img loading="lazy" className="instagram__img" src={inta} width={230} height={230} alt="Insta image 12" />
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="row row-cols-lg-5 row-cols-2">
                            <div className="footer-column footer-store-info col-12 mb-4 mb-lg-0">
                                ...
                                <ul className="social-links list-unstyled d-flex flex-wrap mb-0">
                                    ...
                                    <li>
                                        <a href="https://youtube.com/" className="footer__social-link d-block">
                                            <svg className="svg-icon svg-icon_youtube" width={16} height={11} viewBox="0 0 16 11" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="footer-column footer-menu mb-4 mb-lg-0">
                                ...
                                <ul className="sub-menu__list list-unstyled">
                                    ...
                                    <li className="sub-menu__item"><a href="account_dashboard.html" className="menu-link menu-link_us-s">My Account</a>
                                    </li>
                                    <li className="sub-menu__item"><a href="store_location.html" className="menu-link menu-link_us-s">Find a Store</a>
                                    </li>
                ...
                <div className="aside aside_right overflow-hidden customer-forms" id="customerForms">
                    <div className="customer-forms__wrapper d-flex position-relative">
                        <div className="customer__login">
                            ...
                            <form action="https://uomo-html.flexkitux.com/Demo1/login_register.html" method="POST" className="aside-content">
                                <div className="form-floating mb-3">
                                    ...
                                    <label htmlFor="customerNameEmailInput">Username or email address *</label>
                                </div>
                                <div className="pb-3" />
                                <div className="form-label-fixed mb-3">
                                    <label htmlFor="customerPasswordInput" className="form-label">Password *</label>
                                ...
                                <div className="d-flex align-items-center mb-3 pb-2">
                                    <div className="form-check mb-0">
                                        <input name="remember" className="form-check-input form-check-input_fill" type="checkbox" defaultValue id="flexCheckDefault" />
                        ...
                        <div className="customer__register">
                            ...
                            <form action="https://uomo-html.flexkitux.com/Demo1/login_register.html" method="POST" className="aside-content">
                                ...
                                <p className="text-secondary mb-4">Your personal data will be used to support your experience throughout this
                ...
                <div className="aside aside_right overflow-hidden cart-drawer" id="cartDrawer">
                    ...
                    <div className="aside-content cart-drawer-items-list">
                        <div className="cart-drawer-item d-flex position-relative">
                            <div className="position-relative">
                                <a href="product1_simple.html">
                                    <img loading="lazy" className="cart-drawer-item__img" src="../images/cart-item-1.jpg" alt />
                                </a>
                            </div>
                            <div className="cart-drawer-item__info flex-grow-1">
                                <h6 className="cart-drawer-item__title fw-normal"><a href="product1_simple.html">Zessi Dresses</a></h6>
                        ...
                        <div className="cart-drawer-item d-flex position-relative">
                            <div className="position-relative">
                                <a href="product1_simple.html">
                                    <img loading="lazy" className="cart-drawer-item__img" src="../images/cart-item-2.jpg" alt />
                                </a>
                            </div>
                            <div className="cart-drawer-item__info flex-grow-1">
                                <h6 className="cart-drawer-item__title fw-normal"><a href="product1_simple.html">Kirby T-Shirt</a></h6>
                        ...
                        <div className="cart-drawer-item d-flex position-relative">
                            <div className="position-relative">
                                <a href="product1_simple.html">
                                    <img loading="lazy" className="cart-drawer-item__img" src="../images/cart-item-3.jpg" alt />
                                </a>
                            </div>
                            <div className="cart-drawer-item__info flex-grow-1">
                                <h6 className="cart-drawer-item__title fw-normal"><a href="product1_simple.html">Cableknit Shawl</a></h6>
                    ...
                    <div className="cart-drawer-actions position-absolute start-0 bottom-0 w-100">
                        ...
                        <a href="shop_cart.html" className="btn btn-light mt-3 d-block">View Cart</a>
                        <a href="shop_checkout.html" className="btn btn-primary mt-3 d-block">Checkout</a>
                    </div>{/* /.aside-content */}
                </div>{/* /.aside */}
                {/* Sitemap */}
